...
} else throw `*❐┃سوي ريبلاي على صورة او فيديو مشان يتحول لملصق┃🌃❯* ${usedPrefix + command}`
} catch {
stiker = '*❐┃سوي ريبلاي على صورة او فيديو مشان يتحول لملصق┃🌃❯*'	
} finally {
m.reply(stiker)}}
handler.help = ['sfull']
handler.tags = ['sticker']
handler.command = /^ملصق|ملصقي?$/i
